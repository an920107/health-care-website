...
export default class RestaurantRepoImpl implements AttachmentRepo{
    async query({
        page,
        category,
        visibility,
    ...
    async create(restaurant: AttachmentEntity): Promise<void> {
    ...
    async update(restaurant: AttachmentEntity): Promise<void> {

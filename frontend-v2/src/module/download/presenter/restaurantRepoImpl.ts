...
export default class RestaurantRepoImpl implements DownloadRepo{
    async query({
        page,
        category,
        visibility,
    ...
    async get(id: number): Promise<DownloadEntity> {
    ...
    async create(restaurant: DownloadEntity): Promise<void> {
    ...
    async update(restaurant: DownloadEntity): Promise<void> {

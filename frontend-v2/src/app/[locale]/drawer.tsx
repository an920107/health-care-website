...
export default function Drawer({ isOpen, onClose: closeCallback }: Props) {
  ...
  return (
    <>
      ...
      <div id="drawer" className={`fixed top-0 left-0 buttom-0 h-screen bg-white w-72 rounded-r-xl transform ${isOpen ? "translate-x-0" : "-translate-x-full"} transition-transform duration-300 ease-in-out`}>

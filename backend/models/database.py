...
class SchemaMixin:
    ...
    def to_dict(self):
        ...
        dict_representation['updated_time'] = dict_representation['updated_time'].isoformat()
        dict_representation['created_time'] = dict_representation['created_time'].isoformat()
